...
def index():
    if request.method=='POST':
        #Gat all the answers from the form using the id
        ...
        #We should take them in order the way we have on our dataset
        ...
        #prediction of the features
        prediction = loaded_model.predict(features)

        #show result on html file
        return render_template('index.html', prediction=prediction[0])
    
    #if the condition isnt true
